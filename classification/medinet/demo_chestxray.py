...
parser = argparse.ArgumentParser(description='WILDCAT/Weldon Training')
...
def main_chestxray():
    ...
    #COVID-Changed
    #train_dataset = ChestXRay(args.data, 'Supervised_100%2')
    #val_dataset = ChestXRay(args.data, 'val2')
    #round_str = 'double_split_curated_data'
    
    train_dataset = ChestXRay(args.data, 'TRAIN') #COVID-Add link to proper training dataset here 
    val_dataset = ChestXRay(args.data, 'VAL') #COVID-Add link to proper validation dataset here
    round_str = 'rsna_mimic_chex_' #COVID-Change these words
    ...
    mod_name = 'lr{}_lrp{}_{}epochs{}_k{}_maps{}_alpha{}_{}_{}_balanced'.format(args.lr, args.lrp, adam_str, args.epochs, args.k, args.maps, args.alpha, model_str, round_str)
    print(mod_name)
